...
In order to use this notebook, you need to register for a 3LC account.
It also requires a paid [Google Colab](https://colab.research.google.com) plan.
